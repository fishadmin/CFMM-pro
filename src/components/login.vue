<template>
    <div class="content">
        ...
        <ul>
            <li class="lifirst">
            <input type="text" value="" v-model="yhm" @input="zh" />
            <span>帐号</span>
            </li>
            <li>
            <input type="text" value="" v-model="mima" @input="mm" />
            <span>密码</span>
            </li>
        </ul>
        <div class="footbox">
...
<style>
    ...
    .content h2{width:20rem;height:20rem; background:url(/static/images/mmp.jpg) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:3rem;}
